...
import 'package:login_signup_screen/admin_confirmation.dart';
...
class AdminReserveScreen extends StatefulWidget {

  const AdminReserveScreen({Key? key}) : super(key: key);

  @override
  _AdminReserveScreenState createState() => _AdminReserveScreenState();
}

class _AdminReserveScreenState extends State<AdminReserveScreen> {
            ...
            child: Column(
                ...
                children:<Widget>[
                 ...
                 FirebaseFirestore.instance.collection('ReservationData').add(
                      ...
                      context,
                      PageRouteBuilder(
                        pageBuilder: (c, a1, a2) =>  AdminConfirmationScreenScreen(_selectedFloor,_selectedTime!,_selectedDay!,n),
                        transitionsBuilder: (c, anim, a2, child) => FadeTransition(opacity: anim, child: child),
